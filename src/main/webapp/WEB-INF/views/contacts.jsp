		...
		<table class="table">
			...
			<tr>
				...
				<td>
					...
					<p>Cynthia is a Java Developer who have goals to change the
						world with technology. My background is in Mechanical Engineering,
			...
			<tr>
				...
				<td>
					...
					<p>Krzysztof is a CPA leveraging GAAP expertise, business
						acumen, and technology skills to transition from a career in
						accounting to full stack software development. Enjoying absorbing
