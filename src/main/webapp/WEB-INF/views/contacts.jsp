...
<%@include file="partials/header.jsp"%>
	...
	<div class="container">
		...
		<h1>Meet AlongTheWay</h1>
			...
			<tr>
				<td><img src="Krzys.jpg" class="img-thumbnail" name="Krzysztof"></td>

				<td>
					<h3>Krzysztof Grabka</h3> <br>

					<p>Krzysztof is a CPA leveraging finance expertise, good business
						acumen, and technology skills to transition from a career in
						accounting to software development. He's enjoying absorbing
						every aspect of coding including front-end, back-end, and database
						code. Strongly motivated by continuous learning and providing
						comprehensive solutions to complex problems. Krzysztof is looking forward
						to applying his skills to the technology sector, being a part of
			...
			<tr>
				<td><img src="Tom.jpeg" class="img-thumbnail" name="Tom"></td>

				<td>
					<h3>Tom Hagey</h3> <br>
					<p>Tom is a motivated learner who is transitioning from sales
						to technology and web development. The prospect of blending the
						skills learned thorough previous academic accomplishments, the
